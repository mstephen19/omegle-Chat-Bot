...
window.onload = function () {
  ...
  divBox.classList.add('mainDivBox');
  divBox.style.position = 'fixed';
  divBox.style.right = '10px';
  divBox.style.top = '10px';
  divBox.style.width = '20vw';
  divBox.style.height = '23vh';
  divBox.style.background = 'linear-gradient(50deg, #409ef7, #cad5ea)';
  ...
  inputArea.style.fontFamily = 'Verdana, Geneva, Tahoma, sans-serif';
  ...
  divBox.appendChild(buttonsDiv);
  buttonsDiv.style.width = '15vw';
  buttonsDiv.style.height = '10vh';
  ...
  //start of mainscript
  //this rainbow console log was stolen from https://stackoverflow.com/questions/7505623/colors-in-javascript-console
  var css =
  ...
  console.log('%cCreated by %s', css, 'Matt Stephens');
  alert(
    '1. Using this ChatBot could result in being temporarily banned from Omegle.\n2. To see live feed of how many times the script has been run, check console.\n3. Recommended to type in message prior to starting any chats.\n4. Have fun!'
  );
  ...
  startFuncBtn.addEventListener('click', function chatBot() {
    // button stuff=============================================================
    document.querySelector('.startBtn').style.boxShadow = '0px 1px 0 black';
    document.querySelector('.startBtn').style.transform = 'translate(-1px, 2px';
    setTimeout(function () {
      document.querySelector('.startBtn').style.boxShadow = '-1px 3px 0 black';
      document.querySelector('.startBtn').style.transform =
        'translate(0px, 0px';
    }, 150);
    // ==========================================================================
    ...
    function chatBot() {
      ...
      scriptCount++;
      console.log(`Script has been run ${scriptCount} times`);
    }
    // console.log(userMessage) //good output
    stopFuncBtn.addEventListener('click', function () {
      // button stuff=============================================================
      document.querySelector('.stopBtn').style.boxShadow = '0px 1px 0 black';
      document.querySelector('.stopBtn').style.transform =
        'translate(-1px, 2px';
      setTimeout(function () {
      ...
      setTimeout(function () {
        alert(
          `Automatically sent ${scriptCount} messages during this session.\nReload page to reset this value.`
        );
      }, 250);
    });
  });
