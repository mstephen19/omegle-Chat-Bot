...
window.onload = function(){
    ...
    startFuncBtn.addEventListener('click', function chatBot(){
        ...
        function chatBot(){
            ...
            send.click();
            setTimeout(function(){ dscn.click(); }, 700);
            setTimeout(function(){ dscn.click(); }, 700);
            setTimeout(function(){ dscn.click(); }, 1500);
            scriptCount++
        ...
        stopFuncBtn.addEventListener('click', function(){
            ...
            document.querySelector('.stopBtn').style.transform = "translate(-1px, 2px";
            setTimeout(function(){
